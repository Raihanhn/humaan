...
export default function Piqueone() {
  return (
    <div className="relative w-full h-[120vh] rounded-3xl overflow-hidden mt-30">
      {/* Background Image */}
      <Image
      ...
      <div className="absolute inset-0 flex justify-center items-center">
        <div className="w-[90%] md:w-[70%] lg:w-[70%] aspect-video rounded-3xl overflow-hidden shadow-lg">
          <video
